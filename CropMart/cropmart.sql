...
--
ALTER TABLE `transaction`
ADD FOREIGN KEY (`bid`) REFERENCES `buyer` (`bid`) on Delete cascade;
ALTER TABLE `fproduct`
ADD FOREIGN KEY (`fid`) REFERENCES `farmer` (`fid`) on Delete cascade;
ALTER TABLE `favorites`
ADD FOREIGN KEY (`bid`) REFERENCES `buyer` (`bid`) on Delete cascade;
ALTER TABLE `review`
ADD FOREIGN KEY (`pid`) REFERENCES `fproduct` (`pid`) on Delete cascade;
