						...
						while ($row = $result->fetch_array()):
							...
							<div class="col-md-4">
								<section>
									...
									<a href="review.php?pid=<?php echo $row['pid']; ?>"> <img class="image fit"
											src="<?php echo $picDestination; ?>" height="220px;" /></a>

									<div style="align: left">
										<blockquote>
											<?php echo "Type : " . $row['pcat'] . ''; ?><br><?php echo "Price : Rs " . $row['price'] . ' /Kg'; ?><br>
										</blockquote>
