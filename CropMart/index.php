...
<body>
	...
	<footer class="footer-distributed" style="background-color:black" id="aboutUs">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">CropMart &copy; </h3>
			<br />
		...
		<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:CropMart@gmail.com" style="color:white">CropMart@gmail.com</a>
				</p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About CropMart</b></span>
				CropMart is e-commerce trading platform for grocerries...
			</p>
