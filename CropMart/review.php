	...
	<section id="main" class="wrapper style1 align-center">
			...
			<center>
				<div class="row uniform">
					<div class="6u 12u$(large)">
						<a href="favorites.php?flag=1&pid=<?= $pid; ?>" class="btn btn-primary"
		...
		<div class="container">
			...
			<form method="POST" action="reviewInput.php?pid=<?= $pid; ?>">
				<div class="row">
					<div class="col-sm-7">
						<textarea style="background-color:white;color: black;" cols="5" name="comment"
